    ...
    const icer_packet_context *context)
{
    ...
    icer_image_segment_typedef *packet = (icer_image_segment_typedef *)
        (output_data->data_start + output_data->size_used);
